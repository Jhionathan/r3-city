...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("torneira-inox-banheiro-construcao")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/building/bathroom.jpeg" alt="banheiro" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Torneira Inox" onClick={() => (handleButtonClick("torneira-inox-banheiro-construcao"))} className="bottom-[35%] left-[45%]" />
                    <ButtonUse title="Vaso Sanitario" onClick={() => (handleButtonClick("vaso-sanitario-banheiro-construcao"))} className="bottom-[25%] left-[25%]" />
                    <ButtonUse title="Piso Porcelanato" onClick={() => (handleButtonClick("piso-porcelanato-banheiro-construcao"))} className="bottom-[5%] left-[40%]" />
                    <ButtonUse title="Pia em Granito" onClick={() => (handleButtonClick("pia-granito-banheiro-construcao"))} className="bottom-[25%] left-[65%]" />
                    <ButtonUse title="Divisoria" onClick={() => (handleButtonClick("divisoria-banheiro-construcao"))} className="bottom-[60%] left-[35%]" />
                    <ButtonUse title="Espelho" onClick={() => (handleButtonClick("espelho-banheiro-construcao"))} className="bottom-[55%] left-[80%]" />
                </div>
