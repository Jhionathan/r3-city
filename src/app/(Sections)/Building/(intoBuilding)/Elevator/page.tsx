...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("espelho-elevador-construcao")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/building/elevador.jpeg" alt="Elevador" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Espelho" onClick={() => (handleButtonClick("espelho-elevador-construcao"))} className="bottom-[55%] left-[5%]" />
                    <ButtonUse title="Parede e Corrimão Aço inox" onClick={() => (handleButtonClick("parede-corrimao-aço-construcao"))} className="bottom-[25%] left-[25%]" />
                    <ButtonUse title="Piso Granito" onClick={() => (handleButtonClick("piso-granito-elevador-construcao"))} className="bottom-[0%] left-[40%]" />
                </div>
