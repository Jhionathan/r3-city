...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("vidro-sala-construcao")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/building/sala.jpeg" alt="Sala" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Vidro" onClick={() => (handleButtonClick("vidro-sala-construcao"))} className="bottom-[45%] left-[45%]" />
                    <ButtonUse title="Porta Madeira" onClick={() => (handleButtonClick("porta-madeira-sala-construcao"))} className="bottom-[55%] left-[5%]" />
                    <ButtonUse title="Forro de Gesso" onClick={() => (handleButtonClick("forro-geso-sala-construcao"))} className="bottom-[90%] left-[40%]" />
                    <ButtonUse title="Maçaneta e Puxadores de Aluminio" onClick={() => (handleButtonClick("macaneta-aluminio-sala-construcao"))} className="bottom-[45%] left-[75%]" />
                    <ButtonUse title="Piso Granilito" onClick={() => (handleButtonClick("piso-granilito-sala-construcao"))} className="bottom-[10%] left-[35%]" />
                </div>
