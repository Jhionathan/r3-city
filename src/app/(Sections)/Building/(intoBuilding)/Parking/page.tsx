...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("piso-cimento-queimado-estacionamento-construcao")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/building/estacionamento.jpeg" alt="Estacionamento" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Piso em Cimento Queimado" onClick={() => (handleButtonClick("piso-cimento-queimado-estacionamento-construcao"))} className="bottom-[5%] left-[5%]" />
                    <ButtonUse title="Paredes e Colunas" onClick={() => (handleButtonClick("paredes-colunas-estacionemento-construcao"))} className="bottom-[40%] left-[15%]" />
                    <ButtonUse title="Teto com Bolor" onClick={() => (handleButtonClick("teto-bolor-estacionamento-construcao"))} className="bottom-[70%] left-[40%]" />
                </div>
