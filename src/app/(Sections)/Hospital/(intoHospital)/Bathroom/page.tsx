...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("azulejo-banheiro-hospital")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/hospital/hospitalbathroom.jpeg" alt="banheiro" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Azulejo" onClick={() => (handleButtonClick("azulejo-banheiro-hospital"))} className="bottom-[80%] left-[50%]" />
                    <ButtonUse title="Pia" onClick={() => (handleButtonClick("pia-banheiro-hospital"))} className="bottom-[35%] left-[50%]" />
                    <ButtonUse title="Espelho" onClick={() => (handleButtonClick("espelho-banheiro-hospital"))} className="bottom-[55%] left-[30%]" />
                    <ButtonUse title="Lixeiras" onClick={() => (handleButtonClick("lixeiras-banheiro-hospital"))} className="bottom-[15%] left-[30%]" />
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-banheiro-hospital"))} className="bottom-[5%] left-[50%]" />
