...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("piso-corredor-hospital")
        ...
        <div className="min-h-screen relative">
            ...
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-corredor-hospital"))} className="bottom-[5%] left-[50%]" />
                    <ButtonUse title="Porta" onClick={() => (handleButtonClick("porta-corredor-hospital"))} className="bottom-[40%] left-[35%]" />
                    <ButtonUse title="Mural" onClick={() => (handleButtonClick("mural-corredor-hospital"))} className="bottom-[50%] left-[15%]" />
                    <ButtonUse title="Vidros" onClick={() => (handleButtonClick("vidros-corredor-hospital"))} className="bottom-[55%] left-[65%]" />
                    <ButtonUse title="Maçaneta de Portas" onClick={() => (handleButtonClick("macaneta-porta-corredor-hospital"))} className="bottom-[45%] left-[45%]" />
                    <ButtonUse title="Monitores de Led" onClick={() => (handleButtonClick("monitores-corredor-hospital"))} className="bottom-[40%] left-[20%]" />
                    <ButtonUse title="Bancada de Madeira" onClick={() => (handleButtonClick("bancada-madeira-corredor-hospital"))} className="bottom-[30%] left-[20%]" />
                </div>
