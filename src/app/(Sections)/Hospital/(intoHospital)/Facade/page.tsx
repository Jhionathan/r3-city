...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("fachada-hospital")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/hospital/facade.jpeg" alt="banheiro" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Fachada" onClick={() => (handleButtonClick("fachada-hospital"))} className="bottom-[55%] left-[50%]" />
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-fachada-hospital"))} className="bottom-[15%] left-[55%]" />
                    <ButtonUse title="Vidros" onClick={() => (handleButtonClick("vidros-fachada-hospital"))} className="bottom-[45%] left-[60%]" />
                </div>
