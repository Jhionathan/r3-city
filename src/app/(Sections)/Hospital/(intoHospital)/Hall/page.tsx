...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("piso-recepcao-hospital")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/hospital/hospitalrecepcao.jpeg" alt="banheiro" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-recepcao-hospital"))} className="bottom-[0%] left-[50%]" />
                    <ButtonUse title="Painel" onClick={() => (handleButtonClick("painel-recepcao-hospital"))} className="bottom-[50%] left-[45%]" />
                    <ButtonUse title="Janelas" onClick={() => (handleButtonClick("janelas-recepcao-hospital"))} className="bottom-[50%] left-[10%]" />
                    <ButtonUse title="Estofados" onClick={() => (handleButtonClick("estofados-recepcao-hospital"))} className="bottom-[35%] left-[25%]" />
                    <ButtonUse title="Bancada de Atendimento" onClick={() => (handleButtonClick("bancada-atendimento-recepcao-hospital"))} className="bottom-[40%] left-[45%]" />
                    <ButtonUse title="Mesa" onClick={() => (handleButtonClick("mesa-recepcao-hospital"))} className="bottom-[15%] left-[75%]" />
                </div>
