...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("piso-quarto-hospital")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/hospital/quarto.jpeg" alt="banheiro" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-quarto-hospital"))} className="bottom-[0%] left-[50%]" />
                    <ButtonUse title="Poltrona" onClick={() => (handleButtonClick("poltrona-quarto-hospital"))} className="bottom-[25%] left-[20%]" />
                    <ButtonUse title="Cama Paciente" onClick={() => (handleButtonClick("cama-paciente-quarto-hospital"))} className="bottom-[30%] left-[40%]" />
                    <ButtonUse title="Equipamentos" onClick={() => (handleButtonClick("equipamentos-quarto-hospital"))} className="bottom-[50%] left-[35%]" />
                    <ButtonUse title="Movéis de Madeira" onClick={() => (handleButtonClick("moveis-madeira-quarto-hospital"))} className="bottom-[45%] left-[45%]" />
                </div>
