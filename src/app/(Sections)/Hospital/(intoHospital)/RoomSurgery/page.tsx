...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("luminaria-cirurgia-hospital")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/hospital/cirurgia.jpeg" alt="banheiro" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Luminaria" onClick={() => (handleButtonClick("luminaria-cirurgia-hospital"))} className="bottom-[65%] left-[55%]" />
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-cirurgia-hospital"))} className="bottom-[5%] left-[45%]" />
                    <ButtonUse title="Bancadas de inox" onClick={() => (handleButtonClick("bancada-inox-cirurgia-hospital"))} className="bottom-[30%] left-[10%]" />
                    <ButtonUse title="Vidros" onClick={() => (handleButtonClick("vidros-cirurgia-hospital"))} className="bottom-[40%] left-[65%]" />
                </div>
