...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("equipamentos-academia-hotel")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/hotel/academia.jpeg" alt="Academia Hotel" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Equipamentos de Ginástica" onClick={() => (handleButtonClick("equipamentos-academia-hotel"))} className="bottom-[30%] left-[25%]" />
                    <ButtonUse title="Vidro" onClick={() => (handleButtonClick("vidro-academia-hotel"))} className="bottom-[60%] left-[25%]" />
                    <ButtonUse title="Ambiente" onClick={() => (handleButtonClick("ambiente-academia-hotel"))} className="bottom-[50%] left-[60%]" />
                    <ButtonUse title="Catracas" onClick={() => (handleButtonClick("catracas-academia-hotel"))} className="bottom-[40%] left-[80%]" />
                    <ButtonUse title="Balcão" onClick={() => (handleButtonClick("balcao-academia-hotel"))} className="bottom-[40%] left-[65%]" />
                    <ButtonUse title="Piso Plurigoma" onClick={() => (handleButtonClick("piso-academia-hotel"))} className="bottom-[10%] left-[60%]" />
                    <ButtonUse title="Sofá" onClick={() => (handleButtonClick("sofa-academia-hotel"))} className="bottom-[30%] left-[90%]" />
                </div>
