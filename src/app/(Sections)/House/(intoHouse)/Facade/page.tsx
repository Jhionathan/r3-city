...
export default function Facade() {
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/house/facade/facade.jpeg" alt="Fachada" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-entrada-casa"))} className="bottom-[5%] left-[50%]" />
                    <ButtonUse title="Porta" onClick={() => (handleButtonClick("porta-entrada-casa"))} className="bottom-[20%] left-[50%]" />
                    <ButtonUse title="Calçada" onClick={() => (handleButtonClick("calcada-casa"))} className="bottom-[-5%] left-[15%]" />
                </div>
