...
export default function Garage() {
    ...
    const [selectedSection, setSelectedSection] = useState("janela-cozinha-casa")
        ...
        <div className="min-h-screen relative">
            ...
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    ...
                    <ButtonUse title="Pia de Inox" onClick={() => (handleButtonClick("pia-inox-cozinha-casa"))} className="bottom-[40%] left-[20%]" />
                    <ButtonUse title="Marmore" onClick={() => (handleButtonClick("marmore-cozinha-casa"))} className="bottom-[45%] left-[70%]" />
                    <ButtonUse title="Fogão" onClick={() => (handleButtonClick("fogao-cozinha-casa"))} className="bottom-[40%] left-[55%]" />
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-cozinha-casa"))} className="bottom-[10%] left-[30%]" />
