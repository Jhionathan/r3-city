...
export default function Facade() {
    ...
    const [selectedSection, setSelectedSection] = useState("porta-vidro-lazer-casa")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/house/leisure/lazer.jpeg" alt="Fachada" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Porta de Vidro" onClick={() => (handleButtonClick("porta-vidro-lazer-casa"))} className="bottom-[45%] left-[80%]" />
                    <ButtonUse title="Espreguiçadeira" onClick={() => (handleButtonClick("espreguicadeira-lazer-casa"))} className="bottom-[35%] left-[20%]" />
                    <ButtonUse title="Mesa de Madeira" onClick={() => (handleButtonClick("mesa-madeira-lazer-casa"))} className="bottom-[40%] left-[60%]" />
                    <ButtonUse title="Revestimento Externo" onClick={() => (handleButtonClick("revestimento-lazer-casa"))} className="bottom-[10%] left-[70%]" />
