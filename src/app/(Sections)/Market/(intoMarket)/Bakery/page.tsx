...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("piso-granilite-padaria")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/supermarket/Padaria.jpg" alt="Padaria" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Piso Granilite" onClick={() => (handleButtonClick("piso-granilite-padaria"))} className="bottom-[5%] left-[50%]" />
                    <ButtonUse title="Vitrine de Vidro" onClick={() => (handleButtonClick("vitrine-vidro-padaria"))} className="bottom-[25%] left-[70%]" />
                    <ButtonUse title="Maquina de Lavar-louças" onClick={() => (handleButtonClick("maquina-lavar-loucas-padaria"))} className="bottom-[35%] left-[50%]" />
                    <ButtonUse title="Vidros" onClick={() => (handleButtonClick("vidros-padaria"))} className="bottom-[45%] left-[60%]" />
