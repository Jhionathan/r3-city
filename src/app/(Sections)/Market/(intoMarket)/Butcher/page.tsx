...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("parede-azulejo-acougue")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/supermarket/açougue-2.jpeg" alt="Padaria" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Parede de Azulejo" onClick={() => (handleButtonClick("parede-azulejo-acougue"))} className="bottom-[45%] left-[5%]" />
                    <ButtonUse title="Vitrine de Vidro" onClick={() => (handleButtonClick("vitrine-vidro-acougue"))} className="bottom-[25%] left-[30%]" />
                    <ButtonUse title="Bancada de Inox" onClick={() => (handleButtonClick("bancada-inox-acougue"))} className="bottom-[35%] left-[20%]" />
                    <ButtonUse title="Pia" onClick={() => (handleButtonClick("pia-acougue"))} className="bottom-[30%] left-[80%]" />
                    <ButtonUse title="Moedor de Carne" onClick={() => (handleButtonClick("moedor-carne-acougue"))} className="bottom-[35%] left-[50%]" />
                    <ButtonUse title="Refrigerador" onClick={() => (handleButtonClick("refrigerador-acougue"))} className="bottom-[20%] left-[50%]" />
                    <ButtonUse title="Tabua de Carne" onClick={() => (handleButtonClick("tabua-carne-acougue"))} className="bottom-[30%] left-[60%]" />
