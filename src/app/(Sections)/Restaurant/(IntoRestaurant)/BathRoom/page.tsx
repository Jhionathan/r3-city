...
export default function BathRoom() {
    ...
    return (    
        <div className="min-h-screen relative">
            <Image
                src="/restaurant/bathroom/bathroom.jpg" height={1920} width={1080} alt="vitrine"
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Pia" onClick={() => (handleButtonClick("pia-banheiro"))} className="bottom-[35%] left-[50%]" />
                    <ButtonUse title="Dispenser" onClick={() => (handleButtonClick("dispenser"))} className="bottom-[45%] left-[65%]"/>
                    <ButtonUse title="Lixeira" onClick={() => (handleButtonClick("lixeira-banheiro"))} className="bottom-[12%] left-[78%]"/>
                    <ButtonUse title="Espelho" onClick={() => (handleButtonClick("espelho"))} className="bottom-[66%] left-[48%]"/>
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-banheiro"))} className="bottom-[-3%] left-[48%]"/>
                    <ButtonUse title="Vaso Sanitário" onClick={() => (handleButtonClick("vaso-sanitario"))} className="bottom-[7%] left-[77%]"/>
