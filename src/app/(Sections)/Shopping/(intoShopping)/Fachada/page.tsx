...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("painel-fachada-shopping")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/shopping/fachada.jpeg" alt="Fachada Shopping" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Painel" onClick={() => (handleButtonClick("painel-fachada-shopping"))} className="bottom-[40%] left-[25%]" />
                    <ButtonUse title="Vidro" onClick={() => (handleButtonClick("vidro-fachada-shopping"))} className="bottom-[45%] left-[45%]" />
                    <ButtonUse title="Pedra Mineral" onClick={() => (handleButtonClick("pedra-mineral-fachada-shopping"))} className="bottom-[10%] left-[60%]" />
                </div>
