...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("ambiente-universidade-corredor")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/university/corredor.jpeg" alt="Corredor" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Ambiente" onClick={() => (handleButtonClick("ambiente-universidade-corredor"))} className="bottom-[70%] left-[30%]" />
                    <ButtonUse title="Janela" onClick={() => (handleButtonClick("janela-universidade-corredor"))} className="bottom-[45%] left-[10%]" />
                    <ButtonUse title="Portas" onClick={() => (handleButtonClick("portas-universidade-corredor"))} className="bottom-[50%] left-[80%]" />
                    <ButtonUse title="Painel" onClick={() => (handleButtonClick("painel-universidade-corredor"))} className="bottom-[45%] left-[35%]" />
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-universidade-corredor"))} className="bottom-[5%] left-[65%]" />
                    <ButtonUse title="Bancos" onClick={() => (handleButtonClick("bancos-universidade-corredor"))} className="bottom-[25%] left-[20%]" />
                </div>
