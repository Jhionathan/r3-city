...
export default function Bathroom() {
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/university/fachada.jpeg" alt="Fachada" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Fachada" onClick={() => (handleButtonClick("universidade-fachada"))} className="bottom-[75%] left-[30%]" />
                    <ButtonUse title="Vidro" onClick={() => (handleButtonClick("vidro-universidade-fachada"))} className="bottom-[45%] left-[25%]" />
                    <ButtonUse title="Bancos" onClick={() => (handleButtonClick("bancos-universidade-fachada"))} className="bottom-[25%] left-[45%]" />
                    <ButtonUse title="Calçada" onClick={() => (handleButtonClick("calcada-universidade-fachada"))} className="bottom-[15%] left-[35%]" />
                </div>
