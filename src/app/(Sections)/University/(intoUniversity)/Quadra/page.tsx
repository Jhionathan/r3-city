...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("vidro-universidade-fachada")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/university/quadra.jpeg" alt="Quadra de Esportes" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Tabela de Basquete" onClick={() => (handleButtonClick("tabela-basquete-universidade-quadra"))} className="bottom-[45%] left-[45%]" />
                    <ButtonUse title="Cadeiras" onClick={() => (handleButtonClick("cadeiras-universidade-quadra"))} className="bottom-[30%] left-[15%]" />
                    <ButtonUse title="Arquibancadas" onClick={() => (handleButtonClick("arquibancadas-universidade-quadra"))} className="bottom-[30%] left-[45%]" />
                    <ButtonUse title="Piso de cimento queimado" onClick={() => (handleButtonClick("piso-universidade-quadra"))} className="bottom-[15%] left-[35%]" />
                </div>
