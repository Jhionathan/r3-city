...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("janelas-universidade-sala")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/university/saladeaula.jpeg" alt="Sala de Aula" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Janelas" onClick={() => (handleButtonClick("janelas-universidade-sala"))} className="bottom-[45%] left-[10%]" />
                    <ButtonUse title="Mesa e Cadeiras" onClick={() => (handleButtonClick("cadeiras-mesas-universidade-sala"))} className="bottom-[20%] left-[15%]" />
                    <ButtonUse title="Reverstimento de Madeira" onClick={() => (handleButtonClick("revestimento-universidade-sala"))} className="bottom-[65%] left-[25%]" />
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-universidade-sala"))} className="bottom-[15%] left-[45%]" />
                </div>
