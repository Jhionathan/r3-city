...
export default function Bathroom() {
    ...
    const [selectedSection, setSelectedSection] = useState("janelas-universidade-secretaria")
    ...
    return (
        <div className="min-h-screen relative">
            <Image src="/university/secretaria.jpeg" alt="Secretaria" width={1920} height={1080}
                className="w-full h-full object-cover" />
            <Container>
                <div className="absolute w-full h-screen top-0 left-0">
                    <ButtonUse title="Janelas" onClick={() => (handleButtonClick("janelas-universidade-secretaria"))} className="bottom-[45%] left-[75%]" />
                    <ButtonUse title="Ambiente" onClick={() => (handleButtonClick("ambiente-mesas-universidade-secretaria"))} className="bottom-[50%] left-[15%]" />
                    <ButtonUse title="Equipamentos" onClick={() => (handleButtonClick("equipamentos-universidade-secretaria"))} className="bottom-[35%] left-[15%]" />
                    <ButtonUse title="Bancada" onClick={() => (handleButtonClick("bancada-universidade-secretaria"))} className="bottom-[25%] left-[20%]" />
                    <ButtonUse title="Estofados" onClick={() => (handleButtonClick("estofados-universidade-secretaria"))} className="bottom-[25%] left-[75%]" />
                    <ButtonUse title="Piso" onClick={() => (handleButtonClick("piso-universidade-secretaria"))} className="bottom-[15%] left-[45%]" />
                </div>
