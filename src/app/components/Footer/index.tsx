                ...
                <div className="max-w-3xl mx-auto">
                   <Link href="/" className="flex items-center justify-center">
                    ...
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-10 mb-10 border-b border-gray-200">
                        <li>
                            <a href="javascript:;" className="text-gray-800 hover:text-gray-900">R3 Suprimentos</a>
                        </li>
                        <li>
                            <a href="javascript:;" className=" text-gray-800 hover:text-gray-900">Produtos</a>
                        </li>
                        <li>
                            <a href="javascript:;" className=" text-gray-800 hover:text-gray-900">Institucional</a>
                        </li>
                        <li>
                            <a href="javascript:;" className=" text-gray-800 hover:text-gray-900">Suporte</a>
                        </li>
                    </ul>
                    ...
                    <span className="text-lg text-gray-500 text-center block"><a href="https://pagedone.io/">R3 Suprimentos</a> 2024, Todos os direitos reservados.</span>
                </div>
            </div>
        </footer>
    )
